...
jQuery(function($) {
        ...
        top_menu_height = $('.kha-top-menu').height();
        // scroll spy to auto active the nav item
        $('body').scrollspy({ target: '#kha-nav-bar', offset: top_menu_height + 10 });
		$('.external-link').unbind('click');
        ...
        $('.kha-top-menu .navbar-nav a').click(function(e){
            e.preventDefault(); 
		...
		*/
        ...
        $('.kha-top-menu ').stickUp();

        // gallery category
        $('.kha-gallery-category a').click(function(e){
            e.preventDefault(); 
